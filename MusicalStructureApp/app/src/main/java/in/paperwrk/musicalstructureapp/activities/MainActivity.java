...
import in.paperwrk.musicalstructureapp.fragments.HomeFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final IProfile profile = new ProfileDrawerItem().withName(R.string.username)
                .withEmail(R.string.userEmail).withIcon(R.drawable.droid);
